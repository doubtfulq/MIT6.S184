...
\newcommand{\ph}[1]{{\color{magenta}{\bf[Peter:} #1{\bf]}}}
\newcommand{\ee}[1]{{\color{RoyalBlue}{\bf[Ezra:} #1{\bf]}}}

% flow_matching library
\newcommand{\fmlibrary}{\Verb{flow_matching} library}
\newcommand{\fmlibrarywithurl}{\Verb{flow_matching} library (\url{https://github.com/facebookresearch/flow_matching})}
...
\newcommand{\uref}{u^{\text{target}}}
\newcommand{\Lcond}{\mathcal{L}_{\text{CFM}}}
\newcommand{\Lmarg}{\mathcal{L}_{\text{FM}}}
\newcommand{\uflow}{u^{\text{flow}}}
\newcommand{\fref}{\psi^{\text{ref}}}
\newcommand{\psiflow}{\psi^{\text{flow}}}
\newcommand{\uforw}{u^{\text{forw}}}
\newcommand{\sigforw}{\sigma^{\text{forw}}}
\newcommand{\psiref}{\psi^{\text{target}}}
...
\newcommand{\defe}{\coloneqq}%{\stackrel{\text{def}}{=}}
...
\newcommand{\mask}{\texttt{m}} %mask token
\newcommand{\ignore}{\texttt{i}} %ignore token
...
% %\newtheorem{proposition}\renewcommand{\section}{Proposition}
...
% for hadeling repeated theorems/lemmas/...
% \makeatletter
...
%usage:
% \begin{reptheorem}{thm:xxx}[title]
% theorem goes here
% \end{reptheorem} 
...
% % FOR CODE
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \definecolor{codegreen}{rgb}{0,0.6,0} % Define a nice green color for code
